...
public class Conexion {
    ...
    try {    
            ...
            if(ip.equals("127.0.0.1")){
                ...
                dataSource.setUrl("jdbc:mysql://albadti2018.ddns.net:3306/bdDomotica?zeroDateTimeBehavior=convertToNull");
                System.out.println("real");
                valueconecction="real albadti2018.ddns.net";
            }else{
                System.out.println("pruebas");
                dataSource.setPassword("12345678");
                dataSource.setUrl("jdbc:mysql://192.168.1.123:3306/bdDomotica");
